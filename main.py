...
def execute_cmd(cmd: str, voice: str):
    if cmd == 'open_browser':
        webbrowser.open('https://www.google.ru/?hl=ru', new = 2 )
        play("ok")
        ...
        webbrowser.open('https://www.anilibria.tv/', new = 2)

    elif cmd == 'music':
        webbrowser.open('https://www.youtube.com/watch?v=80tx-YduEN4&list=PLQMt8cyo9_4HxBPikdCJN2tcJaI7Nk_vx&index=1', new = 2)
        play("ok")
    ...
    elif cmd == 'next_window':
        pyautogui.hotkey('ctrl','tab')
        # time.sleep(0.2)
        # play("ok")

    elif cmd == 'previous_window':
